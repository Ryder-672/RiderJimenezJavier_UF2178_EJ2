...
public class RiderJimenezJavier_UF2178_EJ2 {
	public static void main(String[] args) {
		...
		Funcion.mostrar_imcs(imcs_pacientes);

		
		System.out.println("¿que paciente buscas?");
		int nPaciente = teclado.nextInt();
		
		System.out.printf("%.2f",Funcion.media_paciente(imcs_pacientes, nPaciente-1));
